 ...
 *   - opencode-router:  tsx dev  (packages/opencode-router)   → http://localhost:3002
 *   - opencode-router-app: tsx dev (packages/opencode-router-app) → http://localhost:5173 (proxied via router)
 *
 ...
 *
 * Run:
 *   cd packages/opencode-router-app && pnpm exec playwright test
 */
